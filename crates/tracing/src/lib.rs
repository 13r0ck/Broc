//! Utilities for turning on tracing in user-facing or test executables of the Broc compiler.
//!
...
//! you should use the exposed members of `broc_tracing` for your tracing needs.
...
/// Sets up tracing of a Broc executable. The value of this macro must be bound to a variable that
