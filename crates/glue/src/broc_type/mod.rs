...
pub struct Types {
    ...
    pub deps: broc_std::BrocList<Tuple2>,
    pub entrypoints: broc_std::BrocList<Tuple1>,
    pub sizes: broc_std::BrocList<u32>,
    pub types: broc_std::BrocList<BrocType>,
    pub typesByName: broc_std::BrocList<Tuple1>,
    pub target: Target,
}
...
impl core::fmt::Debug for discriminant_BrocType {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            Self::Unsized => f.write_str("discriminant_BrocType::Unsized"),
        }
    }
}
...
#[repr(C)]
pub union BrocType {
    Function: core::mem::ManuallyDrop<BrocFn>,
    Num: BrocNum,
    RecursivePointer: u32,
    BrocBox: u32,
    BrocDict: BrocType_BrocDict,
    BrocList: u32,
    BrocResult: BrocType_BrocDict,
    BrocSet: u32,
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            Self::NonNullableUnwrapped => {
                f.write_str("discriminant_BrocTagUnion::NonNullableUnwrapped")
            }
...
pub struct R14 {
    pub name: broc_std::BrocStr,
    pub payload: BrocSingleTagPayload,
...
#[derive(Clone, Copy, Eq, Ord, Hash, PartialEq, PartialOrd)]
#[repr(u8)]
pub enum discriminant_BrocSingleTagPayload {
    HasClosure = 0,
    HasNoClosure = 1,
}

impl core::fmt::Debug for discriminant_BrocSingleTagPayload {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            Self::HasClosure => f.write_str("discriminant_BrocSingleTagPayload::HasClosure"),
            Self::HasNoClosure => f.write_str("discriminant_BrocSingleTagPayload::HasNoClosure"),
        }
    }
}
...
#[repr(C)]
pub union BrocSingleTagPayload {
    HasClosure: core::mem::ManuallyDrop<broc_std::BrocList<R4>>,
    HasNoClosure: core::mem::ManuallyDrop<broc_std::BrocList<R16>>,
    _sizer: [u8; 32],
}
...
#[derive(Clone, Copy, Eq, Ord, Hash, PartialEq, PartialOrd)]
#[repr(u8)]
pub enum discriminant_BrocStructFields {
    HasClosure = 0,
    HasNoClosure = 1,
}

impl core::fmt::Debug for discriminant_BrocStructFields {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            Self::HasClosure => f.write_str("discriminant_BrocStructFields::HasClosure"),
            Self::HasNoClosure => f.write_str("discriminant_BrocStructFields::HasNoClosure"),
        }
    }
}
...
#[repr(C)]
pub union BrocStructFields {
    HasClosure: core::mem::ManuallyDrop<broc_std::BrocList<R2>>,
    HasNoClosure: core::mem::ManuallyDrop<broc_std::BrocList<R4>>,
    _sizer: [u8; 32],
}
...
pub struct BrocFn {
    ...
    pub externName: broc_std::BrocStr,
    pub functionName: broc_std::BrocStr,
    pub lambdaSet: u32,
    pub ret: u32,
...
impl Tuple1 {
    ...
    pub fn T(f0: broc_std::BrocStr, f1: u32) -> Self {
        Self { f0, f1 }
    }
    ...
    pub fn into_T(self) -> (broc_std::BrocStr, u32) {
        (self.f0, self.f1)
    }
    ...
    /// Since `T` only has one tag (namely, `T`),
    /// convert it to `T`'s payload.
    pub fn as_T(&self) -> (&broc_std::BrocStr, &u32) {
        (&self.f0, &self.f1)
    }

    #[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
    /// A tag named T, with the given payload.
    pub fn T(f0: broc_std::BrocStr, f1: u64) -> Self {
        Self { f0, f1 }
    }
    ...
    /// Since `T` only has one tag (namely, `T`),
    /// convert it to `T`'s payload.
    pub fn into_T(self) -> (broc_std::BrocStr, u64) {
        (self.f0, self.f1)
    }
    ...
    /// Since `T` only has one tag (namely, `T`),
    /// convert it to `T`'s payload.
    pub fn as_T(&self) -> (&broc_std::BrocStr, &u64) {
        (&self.f0, &self.f1)
    }
}
...
impl BrocType {
    ...
    pub fn Function(arg0: BrocFn) -> Self {
        let mut answer = Self {
    ...
    pub unsafe fn into_Function(mut self) -> BrocFn {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `Function`.
    pub unsafe fn as_Function(&self) -> &BrocFn {
        debug_assert_eq!(self.discriminant(), discriminant_BrocType::Function);
    ...
    pub fn BrocBox(arg: u32) -> Self {
        let mut answer = Self { BrocBox: arg };
    ...
    pub fn BrocDict(arg0: u32, arg1: u32) -> Self {
        let mut answer = Self {
            BrocDict: BrocType_BrocDict { f0: arg0, f1: arg1 },
        };
    ...
    pub fn BrocList(arg: u32) -> Self {
        let mut answer = Self { BrocList: arg };
    ...
    pub fn BrocResult(arg0: u32, arg1: u32) -> Self {
        let mut answer = Self {
            BrocResult: BrocType_BrocDict { f0: arg0, f1: arg1 },
        };
    ...
    pub fn BrocSet(arg: u32) -> Self {
        let mut answer = Self { BrocSet: arg };
    ...
    pub const Unsized: Self = unsafe {
        ...
        bytes[48] = discriminant_BrocType::Unsized as u8;
    ...
    pub const Unsized: Self = unsafe {
        ...
        bytes[96] = discriminant_BrocType::Unsized as u8;
    ...
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        ...
        unsafe {
            match self.discriminant() {
                ...
                discriminant_BrocType::Unsized => Some(core::cmp::Ordering::Equal),
            }
        }
    }
}
    ...
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        ...
        unsafe {
            match self.discriminant() {
                ...
                discriminant_BrocType::Unsized => core::cmp::Ordering::Equal,
            }
        }
    }
}
    ...
    fn clone(&self) -> Self {
        let mut answer = unsafe {
            match self.discriminant() {
                ...
                discriminant_BrocType::EmptyTagUnion => {
                    core::mem::transmute::<core::mem::MaybeUninit<BrocType>, BrocType>(
                        core::mem::MaybeUninit::uninit(),
                    )
                }
                ...
                discriminant_BrocType::Unit => core::mem::transmute::<
                    ...
                    BrocType,
                >(core::mem::MaybeUninit::uninit()),
                discriminant_BrocType::Unsized => core::mem::transmute::<
                    core::mem::MaybeUninit<BrocType>,
                    BrocType,
                >(core::mem::MaybeUninit::uninit()),
            }
...
impl core::hash::Hash for BrocType {
    ...
    fn hash<H: core::hash::Hasher>(&self, state: &mut H) {
        match self.discriminant() {
            ...
            discriminant_BrocType::Unsized => discriminant_BrocType::Unsized.hash(state),
        }
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        unsafe {
            match self.discriminant() {
                ...
                discriminant_BrocType::Function => {
                    f.debug_tuple("Function").field(&*self.Function).finish()
                }
                discriminant_BrocType::Num => f.debug_tuple("Num").field(&self.Num).finish(),
                discriminant_BrocType::RecursivePointer => f
                    .debug_tuple("RecursivePointer")
                    .field(&self.RecursivePointer)
                    .finish(),
                discriminant_BrocType::BrocBox => {
                    f.debug_tuple("BrocBox").field(&self.BrocBox).finish()
                }
                discriminant_BrocType::BrocDict => f
                    .debug_tuple("BrocDict")
                    .field(&(&self.BrocDict).f0)
                    .field(&(&self.BrocDict).f1)
                    .finish(),
                discriminant_BrocType::BrocList => {
                    f.debug_tuple("BrocList").field(&self.BrocList).finish()
                }
                discriminant_BrocType::BrocResult => f
                    .debug_tuple("BrocResult")
                    .field(&(&self.BrocResult).f0)
                    .field(&(&self.BrocResult).f1)
                    .finish(),
                discriminant_BrocType::BrocSet => {
                    f.debug_tuple("BrocSet").field(&self.BrocSet).finish()
                }
                discriminant_BrocType::BrocStr => f.write_str("BrocStr"),
                discriminant_BrocType::Struct => {
                    f.debug_tuple("Struct").field(&*self.Struct).finish()
                }
                discriminant_BrocType::TagUnion => {
                    f.debug_tuple("TagUnion").field(&*self.TagUnion).finish()
                }
                discriminant_BrocType::TagUnionPayload => f
                    .debug_tuple("TagUnionPayload")
                    .field(&*self.TagUnionPayload)
                    .finish(),
                discriminant_BrocType::Unit => f.write_str("Unit"),
                discriminant_BrocType::Unsized => f.write_str("Unsized"),
            }
        }
    }
}
...
impl Tuple2 {
    #[cfg(any(target_arch = "arm", target_arch = "wasm32", target_arch = "x86"))]
    /// A tag named T, with the given payload.
    pub fn T(f0: u32, f1: broc_std::BrocList<u32>) -> Self {
        Self { f0, f1 }
    }
    ...
    /// Since `T` only has one tag (namely, `T`),
    /// convert it to `T`'s payload.
    pub fn into_T(self) -> (u32, broc_std::BrocList<u32>) {
        (self.f0, self.f1)
    }
    ...
    /// Since `T` only has one tag (namely, `T`),
    /// convert it to `T`'s payload.
    pub fn as_T(&self) -> (&u32, &broc_std::BrocList<u32>) {
        (&self.f0, &self.f1)
    }

    #[cfg(any(target_arch = "aarch64", target_arch = "x86_64"))]
    /// A tag named T, with the given payload.
    pub fn T(f0: u64, f1: broc_std::BrocList<u64>) -> Self {
        Self { f0, f1 }
    }
    ...
    /// Since `T` only has one tag (namely, `T`),
    /// convert it to `T`'s payload.
    pub fn into_T(self) -> (u64, broc_std::BrocList<u64>) {
        (self.f0, self.f1)
    }
    ...
    /// Since `T` only has one tag (namely, `T`),
    /// convert it to `T`'s payload.
    pub fn as_T(&self) -> (&u64, &broc_std::BrocList<u64>) {
        (&self.f0, &self.f1)
    }
}
...
impl BrocTagUnion {
    ...
    pub unsafe fn into_NonNullableUnwrapped(mut self) -> R6 {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocTagUnion::NonNullableUnwrapped
        );
        let payload = {
            let mut uninitialized = core::mem::MaybeUninit::uninit();
            let swapped = unsafe {
    ...
    pub unsafe fn into_NullableUnwrapped(mut self) -> R9 {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocTagUnion::NullableUnwrapped
        );
        let payload = {
            let mut uninitialized = core::mem::MaybeUninit::uninit();
            let swapped = unsafe {
    ...
    pub unsafe fn into_NullableWrapped(mut self) -> R10 {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocTagUnion::NullableWrapped
        );
        let payload = {
            let mut uninitialized = core::mem::MaybeUninit::uninit();
            let swapped = unsafe {
    ...
    pub unsafe fn into_SingleTagStruct(mut self) -> R14 {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocTagUnion::SingleTagStruct
        );
        let payload = {
            let mut uninitialized = core::mem::MaybeUninit::uninit();
            let swapped = unsafe {
...
impl PartialOrd for BrocTagUnion {
    ...
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        ...
        unsafe {
            match self.discriminant() {
                discriminant_BrocTagUnion::Enumeration => {
                ...
                discriminant_BrocTagUnion::NonRecursive => {
...
impl BrocSingleTagPayload {
    #[cfg(any(target_arch = "arm", target_arch = "wasm32", target_arch = "x86"))]
    /// Returns which variant this tag union holds. Note that this never includes a payload!
    pub fn discriminant(&self) -> discriminant_BrocSingleTagPayload {
        unsafe {
            let bytes = core::mem::transmute::<&Self, &[u8; core::mem::size_of::<Self>()]>(self);

            core::mem::transmute::<u8, discriminant_BrocSingleTagPayload>(*bytes.as_ptr().add(12))
        }
    }

    #[cfg(any(target_arch = "arm", target_arch = "wasm32", target_arch = "x86"))]
    /// Internal helper
    fn set_discriminant(&mut self, discriminant: discriminant_BrocSingleTagPayload) {
        let discriminant_ptr: *mut discriminant_BrocSingleTagPayload =
            (self as *mut BrocSingleTagPayload).cast();
    ...
    pub fn HasClosure(arg: broc_std::BrocList<R4>) -> Self {
        let mut answer = Self {
            HasClosure: core::mem::ManuallyDrop::new(arg),
        };

        answer.set_discriminant(discriminant_BrocSingleTagPayload::HasClosure);
    ...
    /// Unsafely assume the given `BrocSingleTagPayload` has a `.discriminant()` of `HasClosure` and convert it to `HasClosure`'s payload.
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `HasClosure`.
    pub unsafe fn into_HasClosure(mut self) -> broc_std::BrocList<R4> {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocSingleTagPayload::HasClosure
        );
        let payload = {
            let mut uninitialized = core::mem::MaybeUninit::uninit();
            let swapped = unsafe {
    ...
    /// Unsafely assume the given `BrocSingleTagPayload` has a `.discriminant()` of `HasClosure` and return its payload.
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `HasClosure`.
    pub unsafe fn as_HasClosure(&self) -> &broc_std::BrocList<R4> {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocSingleTagPayload::HasClosure
        );
    ...
    pub fn HasNoClosure(arg: broc_std::BrocList<R16>) -> Self {
        let mut answer = Self {
            HasNoClosure: core::mem::ManuallyDrop::new(arg),
        };

        answer.set_discriminant(discriminant_BrocSingleTagPayload::HasNoClosure);
    ...
    /// Unsafely assume the given `BrocSingleTagPayload` has a `.discriminant()` of `HasNoClosure` and convert it to `HasNoClosure`'s payload.
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `HasNoClosure`.
    pub unsafe fn into_HasNoClosure(mut self) -> broc_std::BrocList<R16> {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocSingleTagPayload::HasNoClosure
        );
        let payload = {
            let mut uninitialized = core::mem::MaybeUninit::uninit();
            let swapped = unsafe {
    ...
    /// Unsafely assume the given `BrocSingleTagPayload` has a `.discriminant()` of `HasNoClosure` and return its payload.
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `HasNoClosure`.
    pub unsafe fn as_HasNoClosure(&self) -> &broc_std::BrocList<R16> {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocSingleTagPayload::HasNoClosure
        );
    ...
    pub fn discriminant(&self) -> discriminant_BrocSingleTagPayload {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_BrocSingleTagPayload>(*bytes.as_ptr().add(24))
        }
    }
...
impl Drop for BrocSingleTagPayload {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn drop(&mut self) {
        // Drop the payloads
        match self.discriminant() {
            discriminant_BrocSingleTagPayload::HasClosure => unsafe {
                core::mem::ManuallyDrop::drop(&mut self.HasClosure)
            },
            discriminant_BrocSingleTagPayload::HasNoClosure => unsafe {
...
impl Eq for BrocSingleTagPayload {}

impl PartialEq for BrocSingleTagPayload {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn eq(&self, other: &Self) -> bool {
        ...
        unsafe {
            match self.discriminant() {
                discriminant_BrocSingleTagPayload::HasClosure => self.HasClosure == other.HasClosure,
                discriminant_BrocSingleTagPayload::HasNoClosure => {
...
impl PartialOrd for BrocSingleTagPayload {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
...
impl Ord for BrocSingleTagPayload {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
...
impl Clone for BrocSingleTagPayload {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn clone(&self) -> Self {
        let mut answer = unsafe {
            match self.discriminant() {
                discriminant_BrocSingleTagPayload::HasClosure => Self {
                    HasClosure: self.HasClosure.clone(),
                },
                discriminant_BrocSingleTagPayload::HasNoClosure => Self {
...
impl core::hash::Hash for BrocSingleTagPayload {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn hash<H: core::hash::Hasher>(&self, state: &mut H) {
        match self.discriminant() {
            discriminant_BrocSingleTagPayload::HasClosure => unsafe {
                discriminant_BrocSingleTagPayload::HasClosure.hash(state);
                self.HasClosure.hash(state);
            },
            discriminant_BrocSingleTagPayload::HasNoClosure => unsafe {
                discriminant_BrocSingleTagPayload::HasNoClosure.hash(state);
...
impl core::fmt::Debug for BrocSingleTagPayload {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str("BrocSingleTagPayload::")?;

        unsafe {
            match self.discriminant() {
                discriminant_BrocSingleTagPayload::HasClosure => f
                    .debug_tuple("HasClosure")
                    .field(&*self.HasClosure)
                    .finish(),
                discriminant_BrocSingleTagPayload::HasNoClosure => f
...
impl BrocStructFields {
    #[cfg(any(target_arch = "arm", target_arch = "wasm32", target_arch = "x86"))]
    /// Returns which variant this tag union holds. Note that this never includes a payload!
    pub fn discriminant(&self) -> discriminant_BrocStructFields {
        unsafe {
            let bytes = core::mem::transmute::<&Self, &[u8; core::mem::size_of::<Self>()]>(self);

            core::mem::transmute::<u8, discriminant_BrocStructFields>(*bytes.as_ptr().add(12))
        }
    }

    #[cfg(any(target_arch = "arm", target_arch = "wasm32", target_arch = "x86"))]
    /// Internal helper
    fn set_discriminant(&mut self, discriminant: discriminant_BrocStructFields) {
        let discriminant_ptr: *mut discriminant_BrocStructFields =
            (self as *mut BrocStructFields).cast();
    ...
    /// Construct a tag named `HasClosure`, with the appropriate payload
    pub fn HasClosure(arg: broc_std::BrocList<R2>) -> Self {
        let mut answer = Self {
            HasClosure: core::mem::ManuallyDrop::new(arg),
        };

        answer.set_discriminant(discriminant_BrocStructFields::HasClosure);
    ...
    /// Unsafely assume the given `BrocStructFields` has a `.discriminant()` of `HasClosure` and convert it to `HasClosure`'s payload.
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `HasClosure`.
    pub unsafe fn into_HasClosure(mut self) -> broc_std::BrocList<R2> {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocStructFields::HasClosure
        );
        let payload = {
            let mut uninitialized = core::mem::MaybeUninit::uninit();
            let swapped = unsafe {
    ...
    /// Unsafely assume the given `BrocStructFields` has a `.discriminant()` of `HasClosure` and return its payload.
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `HasClosure`.
    pub unsafe fn as_HasClosure(&self) -> &broc_std::BrocList<R2> {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocStructFields::HasClosure
        );
    ...
    /// Construct a tag named `HasNoClosure`, with the appropriate payload
    pub fn HasNoClosure(arg: broc_std::BrocList<R4>) -> Self {
        let mut answer = Self {
            HasNoClosure: core::mem::ManuallyDrop::new(arg),
        };

        answer.set_discriminant(discriminant_BrocStructFields::HasNoClosure);
    ...
    /// Unsafely assume the given `BrocStructFields` has a `.discriminant()` of `HasNoClosure` and convert it to `HasNoClosure`'s payload.
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `HasNoClosure`.
    pub unsafe fn into_HasNoClosure(mut self) -> broc_std::BrocList<R4> {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocStructFields::HasNoClosure
        );
        let payload = {
            let mut uninitialized = core::mem::MaybeUninit::uninit();
            let swapped = unsafe {
    ...
    /// Unsafely assume the given `BrocStructFields` has a `.discriminant()` of `HasNoClosure` and return its payload.
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `HasNoClosure`.
    pub unsafe fn as_HasNoClosure(&self) -> &broc_std::BrocList<R4> {
        debug_assert_eq!(
            self.discriminant(),
            discriminant_BrocStructFields::HasNoClosure
        );
    ...
    pub fn discriminant(&self) -> discriminant_BrocStructFields {
        unsafe {
            ...
            core::mem::transmute::<u8, discriminant_BrocStructFields>(*bytes.as_ptr().add(24))
        }
    }
...
impl Drop for BrocStructFields {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn drop(&mut self) {
        // Drop the payloads
        match self.discriminant() {
            discriminant_BrocStructFields::HasClosure => unsafe {
                core::mem::ManuallyDrop::drop(&mut self.HasClosure)
            },
            discriminant_BrocStructFields::HasNoClosure => unsafe {
                core::mem::ManuallyDrop::drop(&mut self.HasNoClosure)
            },
        }
    }
...
impl Eq for BrocStructFields {}

impl PartialEq for BrocStructFields {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn eq(&self, other: &Self) -> bool {
        ...
        unsafe {
            match self.discriminant() {
                discriminant_BrocStructFields::HasClosure => self.HasClosure == other.HasClosure,
                discriminant_BrocStructFields::HasNoClosure => {
                    self.HasNoClosure == other.HasNoClosure
                }
            }
...
impl PartialOrd for BrocStructFields {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
...
impl Ord for BrocStructFields {
    ...
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        ...
        unsafe {
            match self.discriminant() {
                discriminant_BrocStructFields::HasClosure => self.HasClosure.cmp(&other.HasClosure),
                discriminant_BrocStructFields::HasNoClosure => {
                    self.HasNoClosure.cmp(&other.HasNoClosure)
                }
            }
...
impl Clone for BrocStructFields {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn clone(&self) -> Self {
        let mut answer = unsafe {
            match self.discriminant() {
                discriminant_BrocStructFields::HasClosure => Self {
                    HasClosure: self.HasClosure.clone(),
                },
                discriminant_BrocStructFields::HasNoClosure => Self {
                    HasNoClosure: self.HasNoClosure.clone(),
                },
            }
        };
...
impl core::hash::Hash for BrocStructFields {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn hash<H: core::hash::Hasher>(&self, state: &mut H) {
        match self.discriminant() {
            discriminant_BrocStructFields::HasClosure => unsafe {
                discriminant_BrocStructFields::HasClosure.hash(state);
                self.HasClosure.hash(state);
            },
            discriminant_BrocStructFields::HasNoClosure => unsafe {
                discriminant_BrocStructFields::HasNoClosure.hash(state);
                self.HasNoClosure.hash(state);
            },
        }
    }
...
impl core::fmt::Debug for BrocStructFields {
    #[cfg(any(
        target_arch = "arm",
        target_arch = "aarch64",
        target_arch = "wasm32",
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        f.write_str("BrocStructFields::")?;

        unsafe {
            match self.discriminant() {
                discriminant_BrocStructFields::HasClosure => f
                    .debug_tuple("HasClosure")
                    .field(&*self.HasClosure)
                    .finish(),
                discriminant_BrocStructFields::HasNoClosure => f
                    .debug_tuple("HasNoClosure")
                    .field(&*self.HasNoClosure)
                    .finish(),
            }
