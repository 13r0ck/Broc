...
The correct Broc code is inserted
This is most useful for beginning Broc programmers, but I could see it saving time for experts as well.
Novice to expert programmers who are new to Broc can also perfectly describe what they want to happen but may not know the correct syntax, names of builtin functions...
Other useful snippet commands for beginning Broc programmers might be empty dict, lambda function, split strVal into chars...
...
And contrary to stackoverflow/github copilot, snippets will be written by Broc experts or be easily editable by us. They can also be guaranteed to work for a specific Broc and library version because we update, version, and test them.
...
Fish hooks are used when subvariants should be created e.g.: <collection> means this pure text snippets should be created for all Broc collections such as Dict, Set, List...
