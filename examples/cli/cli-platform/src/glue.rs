...
#[repr(C)]
pub union Error {
    BadBody: core::mem::ManuallyDrop<broc_std::BrocStr>,
    BadRequest: core::mem::ManuallyDrop<broc_std::BrocStr>,
    BadStatus: u16,
    _sizer: [u8; 16],
}
...
#[repr(C)]
pub union U4 {
    MimeType: core::mem::ManuallyDrop<broc_std::BrocStr>,
}
...
pub struct Request {
    ...
    pub body: Body,
    pub headers: broc_std::BrocList<Header>,
    pub url: broc_std::BrocStr,
    pub method: Method,
}
...
pub struct Metadata {
    pub headers: broc_std::BrocList<Header>,
    pub statusText: broc_std::BrocStr,
    pub url: broc_std::BrocStr,
    pub statusCode: u16,
}
...
struct Header_Header {
    pub f0: broc_std::BrocStr,
    pub f1: broc_std::BrocStr,
}
...
impl Error {
    ...
    pub fn BadBody(arg: broc_std::BrocStr) -> Self {
        let mut answer = Self {
    ...
    pub unsafe fn into_BadBody(mut self) -> broc_std::BrocStr {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `BadBody`.
    pub unsafe fn as_BadBody(&self) -> &broc_std::BrocStr {
        debug_assert_eq!(self.discriminant(), discriminant_Error::BadBody);
    ...
    pub fn BadRequest(arg: broc_std::BrocStr) -> Self {
        let mut answer = Self {
    ...
    pub unsafe fn into_BadRequest(mut self) -> broc_std::BrocStr {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `BadRequest`.
    pub unsafe fn as_BadRequest(&self) -> &broc_std::BrocStr {
        debug_assert_eq!(self.discriminant(), discriminant_Error::BadRequest);
...
impl Header {
    ...
    pub fn Header(arg0: broc_std::BrocStr, arg1: broc_std::BrocStr) -> Self {
        let mut answer = Self {
    ...
    pub unsafe fn into_Header(mut self) -> (broc_std::BrocStr, broc_std::BrocStr) {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `Header`.
    pub unsafe fn as_Header(&self) -> (&broc_std::BrocStr, &broc_std::BrocStr) {
        debug_assert_eq!(self.discriminant(), discriminant_Header::Header);
...
impl U4 {
    ...
    pub fn MimeType(arg: broc_std::BrocStr) -> Self {
        let mut answer = Self {
    ...
    pub unsafe fn into_MimeType(mut self) -> broc_std::BrocStr {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `MimeType`.
    pub unsafe fn as_MimeType(&self) -> &broc_std::BrocStr {
        debug_assert_eq!(self.discriminant(), discriminant_U4::MimeType);
...
impl Body {
    ...
    pub fn Body(arg0: U1, arg1: broc_std::BrocList<u8>) -> Self {
        let mut answer = Self {
    ...
    pub unsafe fn into_Body(mut self) -> (U1, broc_std::BrocList<u8>) {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `Body`.
    pub unsafe fn as_Body(&self) -> (&U1, &broc_std::BrocList<u8>) {
        debug_assert_eq!(self.discriminant(), discriminant_Body::Body);
...
impl Response {
    ...
    /// Construct a tag named `BadStatus`, with the appropriate payload
    pub fn BadStatus(arg0: Metadata, arg1: broc_std::BrocList<u8>) -> Self {
        let mut answer = Self {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `BadStatus`.
    pub unsafe fn into_BadStatus(mut self) -> (Metadata, broc_std::BrocList<u8>) {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `BadStatus`.
    pub unsafe fn as_BadStatus(&self) -> (&Metadata, &broc_std::BrocList<u8>) {
        debug_assert_eq!(self.discriminant(), discriminant_Response::BadStatus);
    ...
    pub fn GoodStatus(arg0: Metadata, arg1: broc_std::BrocList<u8>) -> Self {
        let mut answer = Self {
    ...
    pub unsafe fn into_GoodStatus(mut self) -> (Metadata, broc_std::BrocList<u8>) {
    ...
    /// (Always examine `.discriminant()` first to make sure this is the correct variant!)
    /// Panics in debug builds if the `.discriminant()` doesn't return `GoodStatus`.
    pub unsafe fn as_GoodStatus(&self) -> (&Metadata, &broc_std::BrocList<u8>) {
        debug_assert_eq!(self.discriminant(), discriminant_Response::GoodStatus);
